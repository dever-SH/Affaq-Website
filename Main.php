...
<body>
    ...
    <!------Header------>
    <section id="Mheader" class="header">
        <nav class="navBar">
            ...
            <div class="mapdiv">
                ...
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 580 300">
                    <g> <a xlink:title="السودان" href="#" onclick="info(); return false;" target="_blank">
                        ...
                        </a><a xlink:title="مصر" href="egypt.php" target="_blank">
                            <path class="cls-2"
                        ...
                        </a><a xlink:title="المملكة العربية السعودية" href="saudiArabia.php" target="_blank">
                            <path class="cls-3"
                        ...
                        </a><a xlink:title="مملكة الإمارات المتحدة" href="emirates.php" target="_blank">
                            <path class="cls-2"
                        ...
                        </a><a xlink:title="المغرب" href="morocco.php" target="_blank">
                            <path class="cls-3"
                        ...
                        </a><a xlink:title="تونس" href="tunisia.php" target="_blank">
                            <path class="cls-5"
    ...
    <?php
        ...
        if(isset($_POST['subForm'])) {
            ...
            $EmailC = mysqli_query($conn, $EmailQ);
            $EmailR = mysqli_fetch_array($EmailC, MYSQLI_ASSOC);
            if($EmailR["pass"] == $_POST['password']) {
