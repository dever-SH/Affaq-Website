...
<head> 
    ...
    <section class="header">
            <nav class="navBar">
              ...
              <div class="nav-links">
                <ol>
                <li><a href="profile.php" target="_blank_">حسابي</li> <!--  هنا صفحة شادن-->
    ...
    <section class="midmenu">
        <div class="row">
            <div class="midmenu-col">
                ...
                <a  href="" >إستكشف دول العالم العربي!</a>
            </div>
            <div class="midmenu-col">
                <img class="icons"src="Picture/Feather.svg" >
                <a href="">أخبرنا عن رحلتك</a>
            </div>
            <div class="midmenu-col">
                <img class="icons" src="Picture/mapsvg.svg">
                <a href=""> تجول حسب هواياتك</a>
            </div>
        </div>
   </section> 
    <!------ Map ----->
    ...
    <div class="signDiv" id="signinDiv">
        <form class="signForm" id="signinForm" method="post" action="MainPage.php" enctype="multipart/form-data">
